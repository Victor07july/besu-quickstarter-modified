...
df = pd.read_csv("dados_UFRN/dados_monetizacao_novas_emissões_etanol_original_gas_1720_v2.csv")
...
Gemini
O Gemini no Drive não aceita arquivos texto
O Gemini no Workspace pode cometer erros. Por isso, cheque as respostas. Saiba mais